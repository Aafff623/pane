...
const en: Dict = {
  ...
  "overview.non5h": "Metered / Long-term",
  "overview.non5hTip": "No 5-hour window limit (metered or monthly/weekly)",
  "overview.maxedTip": "5-hour quota exhausted (100%)",
  "overview.resetsIn": "5h resets in {time}",
...
const zh: Dict = {
  ...
  "overview.non5h": "按量/长期",
  "overview.non5hTip": "无5小时滑动窗口（按量计费或月/周限额）",
  "overview.maxedTip": "5小时额度已满额 (100%)",
  "overview.resetsIn": "5小时额度 {time} 后重置",
...
const ru: Dict = {
  ...
  "overview.title": "5-часовая квота",
  ...
  "overview.non5h": "Поминутно/Долгосрочно",
  "overview.non5hTip": "Без 5-часового окна (по расходу или за месяц/неделю)",
  "overview.maxedTip": "5-часовая квота исчерпана (100%)",
  "overview.resetsIn": "5ч сброс через {time}",
