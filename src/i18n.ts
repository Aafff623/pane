...
const en: Dict = {
  ...
  "settings.font": "Font",
  "settings.fontPh": "Type to filter installed fonts",
  "settings.fontTip": "Applies to the whole interface. Clear to reset.",
  "settings.fontNone": "No matching fonts",
  ...
  "settings.showTrend": "Show usage trend on cards",
  "settings.showTrendTip":
    "Show the Usage Trend bar on provider cards that log token usage. Off by default — enable this to see quota history on cards that record it.",
  ...
  "settings.onenewapiTokenPh": "Access token (optional, subscription display)",
  "settings.onenewapiTokenSavedPh": "Token saved — leave empty to keep",
  "settings.onenewapiUidPh": "User ID (numeric, required with the access token)",
  "settings.onenewapiTokenHint":
    "NewAPI dashboard token (personal settings → generate access token) plus your numeric user ID shown on the same page — rc builds require both. When set, cards show the site's subscription plan quota and its daily reset instead of the wallet billing numbers.",
  "settings.onenewapiTokenClear": "Clear token",
  "footer.onenewapiTokenSaved": "Access token saved",
  "footer.onenewapiTokenCleared": "Access token cleared",
  ...
  "card.collapse": "Collapse this provider",
  "card.expand": "Expand this provider",
  "card.familyResetsIn": "All accounts in this provider are maxed — resets in {time}",
  "card.familyAllMaxed": "All maxed — resets in",
  "card.rowMaxedResetsIn": "{label} maxed — resets in",
  "card.rowMaxedPending": "{label} maxed — waiting for next reset",
  "card.familyAllMaxedPending": "All accounts are maxed — waiting for next reset",
  "card.foldedResetsIn": "Resets in",
  "card.familyReady": "Quota available",
  "card.refresh": "Refresh this provider now",
  ...
  "overview.sectionAvailable": "Available",
  "overview.expiring": "Soonest reset",
  "overview.expiringEmpty": "No known reset times",
  "overview.pendingReset": "Maxed — waiting for reset",
  "overview.noReset": "No reset time",
  "overview.sectionUnavailable": "Unavailable",
  "customize.groupLabel": "Card group",
  "customize.groupNone": "Ungrouped",
  "customize.groupNew": "New group",
  "customize.groupNewPrompt": "Name the new group",
  "customize.groupRename": "Rename",
  "customize.groupRenameTip": "Rename this group",
  "customize.groupRenamePrompt": "New group name",
  "customize.groupDelete": "Delete",
  "customize.groupDeleteTip": "Delete this group (cards become ungrouped)",
  "customize.groupDeleteConfirm": "Delete group \"{name}\"? Its cards become ungrouped.",
  "customize.groupHelp": "Cards in one group share a dashboard section; the overview can filter to a group.",
  "overview.refresh": "Refresh all",
  "overview.groupHint": "Right-click to group",
  "overview.badge": "{avail}/{total} Available",
  "overview.availShort": "available",
  "overview.maxedBadge": "{n} Maxed Out",
  "overview.maxedShort": "maxed",
  "overview.peakBadge": "{n} in peak hours (standard rate — off-peak is cheaper)",
  "overview.peakShort": "peak",
  "overview.sectionPeak": "Peak hours",
  "overview.allAvailable": "All Available",
  "overview.win5h": "5h quota",
  "overview.winDay": "Daily quota",
  "overview.winWeek": "Weekly quota",
  "overview.winMonth": "Monthly quota",
  "overview.winGeneric": "Quota",
  "overview.noData": "No usage data",
  "overview.maxedTip": "Quota exhausted (100%)",
  "overview.resetsIn": "Resets in {time}",
  "overview.jumpTip": "Click to jump to {name}",
  ...
  "customize.connLabel": "Connectivity:",
  "customize.onaAccountsHint": "Sites are the accounts — add one in the list above: paste the site URL and your dashboard access token, then its card joins the dashboard.",
  "customize.connOk": "OK — last fetch succeeded",
  "customize.connError": "Error — {err}",
  "customize.connNoCred": "No credentials",
  "customize.connUnknown": "Not fetched yet",
  ...
  "customize.acctNoteLabel": "Note name",
  "customize.acctLabelPh": "Note name",
  "customize.acctLabelRequired": "Enter a note name before testing",
  "customize.acctAdd": "Add account",
  "customize.acctClose": "Close",
  "customize.acctSaveBtn": "Save",
  ...
  "customize.acctDefaultFailed": "Could not pin account: {err}",
  "customize.acctRenamed": "Account renamed",
  "customize.acctRenameFailed": "Could not rename account: {err}",
  "customize.agCapture": "Capture current account",
  "customize.agCaptureConfirm": "Snapshot the Google login currently active in the Antigravity IDE into a monitored slot? The token bundle is stored locally and refreshed independently.",
  "customize.agCaptured": "Antigravity account captured — it now gets monitored alongside the logged-in one",
  "customize.agCaptureFailed": "Capture failed: {err}",
  "customize.cursorAddTitle": "Add Cursor account",
  "customize.cursorTabOAuth": "OAuth login",
  "customize.cursorTabToken": "Token",
  "customize.cursorTabJson": "JSON import",
  "customize.cursorOAuthHelp": "Signs in via the Cursor website in your browser (PKCE). The account's quota is then monitored independently.",
  "customize.cursorOAuthStart": "Sign in with browser",
  "customize.cursorOAuthStarting": "Opening browser…",
  "customize.cursorOAuthWaiting": "Waiting for login in browser…",
  "customize.cursorOAuthDone": "Signed in as {email}",
  "customize.cursorTokenLabel": "Access token",
  "customize.cursorRefreshLabel": "Refresh token (optional)",
  "customize.cursorTokenImport": "Import token",
  "customize.cursorTokenConfirm": "Import this token into a monitored Cursor account? It is stored only on this PC and queried independently.",
  "customize.cursorJsonHelp": "Paste a cockpit-compatible JSON: a single object, an array, or {\"accounts\":[…]}. Fields accept camelCase or snake_case aliases.",
  "customize.cursorJsonImport": "Import JSON",
  "customize.cursorImportDone": "Account imported",
  "customize.cursorImportCount": "{n} accounts imported",
  "customize.getApiKey": "Get API key",
  "customize.formKeyHelp": "Stored only on this PC — never uploaded. Save empty to remove.",
  "customize.relayBaseUrlHelp": "Base URL of the relay's quota endpoint; saved together with the key.",
  ...
  "customize.cred.copilot": "GitHub Copilot sign-in (Pane OAuth, gh CLI, or the Copilot app)",
  ...
  "customize.cred.linkso": "Nothing on its own — paste the relay panel's base URL and key",
...
const zh: Dict = {
  ...
  "settings.font": "字体",
  "settings.fontPh": "输入筛选本机已装字体",
  "settings.fontTip": "作用于整个界面；清空恢复默认。",
  "settings.fontNone": "没有匹配的字体",
  ...
  "settings.showTrend": "在卡片上显示用量趋势",
  "settings.showTrendTip":
    "在记录 token 用量的服务商卡片上显示用量趋势柱状图。默认关闭——开启后可在此类卡片上查看配额历史。",
  ...
  "settings.onenewapiTokenPh": "访问令牌（可选，订阅额度显示）",
  "settings.onenewapiTokenSavedPh": "已保存令牌 — 留空则保留",
  "settings.onenewapiUidPh": "用户 ID（数字，填访问令牌时必填）",
  "settings.onenewapiTokenHint":
    "NewAPI 面板令牌（网页 个人设置 → 生成系统访问令牌）+ 同页显示的数字用户 ID（rc 版本两者都要验证）。填写后卡片优先显示该站的订阅套餐额度和每日重置时间，而不是钱包余额。",
  "settings.onenewapiTokenClear": "清除令牌",
  "footer.onenewapiTokenSaved": "访问令牌已保存",
  "footer.onenewapiTokenCleared": "访问令牌已清除",
  ...
  "card.showLess": "收起",
  "card.share": "复制卡片为图片",
  "card.collapse": "折叠此服务商",
  "card.expand": "展开此服务商",
  "card.familyResetsIn": "此服务商下所有账号已打满——{time}后重置",
  "card.familyAllMaxed": "全部打满——重置于",
  "card.rowMaxedResetsIn": "{label} 已打满——重置于",
  "card.rowMaxedPending": "{label} 已打满——等待下次重置",
  "card.familyAllMaxedPending": "所有账号已打满——等待下次重置",
  "card.foldedResetsIn": "下次重置：",
  "card.familyReady": "额度充足",
  "card.refresh": "立即刷新此服务",
  "card.drag": "拖动以排序",
  ...
  "overview.tab5h": "5 小时",
  "overview.tabWeek": "每周",
  "overview.sectionAvailable": "可用",
  "overview.expiring": "最快临期",
  "overview.expiringEmpty": "暂无已知重置时间",
  "overview.pendingReset": "已打满 · 等待重置",
  "overview.noReset": "无重置时间",
  "overview.sectionUnavailable": "不可用",
  "customize.groupLabel": "卡片分组",
  "customize.groupNone": "未分组",
  "customize.groupNew": "新建分组",
  "customize.groupNewPrompt": "给新分组起个名字",
  "customize.groupRename": "改名",
  "customize.groupRenameTip": "重命名这个分组",
  "customize.groupRenamePrompt": "新的分组名",
  "customize.groupDelete": "删除",
  "customize.groupDeleteTip": "删除这个分组（组内卡片变回未分组）",
  "customize.groupDeleteConfirm": "删除分组「{name}」？组内卡片会变回未分组。",
  "customize.groupHelp": "同组卡片在主页归为一个分区；额度总览可按组筛选。",
  "overview.refresh": "一键刷新",
  "overview.groupHint": "右键可分组",
  "overview.badge": "{avail}/{total} 服务可用",
  "overview.availShort": "可用",
  "overview.maxedBadge": "{n} 个已满额",
  "overview.maxedShort": "满额",
  "overview.peakBadge": "{n} 家处于高峰时段（标准倍率计费，低峰更便宜）",
  "overview.peakShort": "高峰",
  "overview.sectionPeak": "高峰",
  "overview.allAvailable": "全部可用",
  "overview.win5h": "5小时额度",
  "overview.winDay": "今日额度",
  "overview.winWeek": "本周额度",
  "overview.winMonth": "本月额度",
  "overview.winGeneric": "额度",
  "overview.noData": "无用量数据",
  "overview.maxedTip": "额度已用满 (100%)",
  "overview.resetsIn": "{time}后重置",
  "overview.jumpTip": "点击跳转至 {name}",
  ...
  "customize.connLabel": "连通性：",
  "customize.onaAccountsHint": "站点就是账号：在上方列表添加站点，填地址和用户访问令牌，测通后主页即出对应额度卡片。",
  "customize.connOk": "正常——上次查询成功",
  "customize.connError": "出错——{err}",
  "customize.connNoCred": "无凭据",
  "customize.connUnknown": "尚未查询",
  ...
  "customize.acctKeyLabel": "API key",
  "customize.acctNoteLabel": "备注名",
  "customize.acctLabelPh": "备注名",
  "customize.acctLabelRequired": "请先填写备注名，再测试连接",
  "customize.acctAdd": "添加账号",
  "customize.acctClose": "收起",
  "customize.acctSaveBtn": "保存",
  ...
  "customize.acctDefaultFailed": "切换置顶账号失败：{err}",
  "customize.acctRenamed": "备注已更新",
  "customize.acctRenameFailed": "重命名失败：{err}",
  "customize.agCapture": "捕获当前账号",
  "customize.agCaptureConfirm": "将 Antigravity IDE 当前登录的 Google 账号凭据快照保存为监控槽？凭据只存在本机，独立刷新。若它就是当前登录账号，主页不会新增卡片（主卡即该账号）。",
  "customize.agCaptured": "已捕获当前登录的 Antigravity 账号，开始并行监控",
  "customize.agCaptureFailed": "捕获失败：{err}",
  "customize.cursorAddTitle": "添加 Cursor 账号",
  "customize.cursorTabOAuth": "OAuth 登录",
  "customize.cursorTabToken": "Token",
  "customize.cursorTabJson": "JSON 导入",
  "customize.cursorOAuthHelp": "通过浏览器在 Cursor 官网完成登录（PKCE），账号额度将被独立监控。",
  "customize.cursorOAuthStart": "浏览器登录",
  "customize.cursorOAuthStarting": "正在打开浏览器…",
  "customize.cursorOAuthWaiting": "等待在浏览器中完成登录…",
  "customize.cursorOAuthDone": "已登录：{email}",
  "customize.cursorTokenLabel": "Access token",
  "customize.cursorRefreshLabel": "Refresh token（可选）",
  "customize.cursorTokenImport": "导入 token",
  "customize.cursorTokenConfirm": "将此 token 导入为受监控的 Cursor 账号？凭据只存在本机，独立查询。",
  "customize.cursorJsonHelp": "粘贴 cockpit 兼容的 JSON：单个对象、数组或 {\"accounts\":[…] }。字段支持 camelCase 或 snake_case。",
  "customize.cursorJsonImport": "导入 JSON",
  "customize.cursorImportDone": "账号已导入",
  "customize.cursorImportCount": "已导入 {n} 个账号",
  "customize.getApiKey": "获取 API key",
  "customize.formKeyHelp": "只存在这台电脑上，不会上传；留空保存即可删除。",
  "customize.relayBaseUrlHelp": "中转站额度接口的基地址，保存时与密钥一起存储。",
  ...
  "customize.cred.copilot": "GitHub Copilot 登录（Pane OAuth、gh CLI 或 Copilot 应用）",
  ...
  "customize.cred.linkso": "不会自动读取 — 请粘贴中转面板的 base URL 和 key",
...
const ru: Dict = {
  ...
  "settings.font": "Шрифт",
  "settings.fontPh": "Введите для поиска шрифтов",
  "settings.fontTip": "Применяется ко всему интерфейсу; очистите для сброса.",
  "settings.fontNone": "Нет подходящих шрифтов",
  ...
  "settings.showTrend": "Показывать тренд использования на карточках",
  "settings.showTrendTip":
    "Показывать столбец тренда использования на карточках провайдеров, которые записывают использование токенов. По умолчанию выключено — включите, чтобы видеть историю квоты на поддерживающих карточках.",
  ...
  "card.collapse": "Свернуть этого провайдера",
  "card.expand": "Развернуть этого провайдера",
  "card.familyResetsIn": "Все аккаунты провайдера исчерпаны — сброс через {time}",
  "card.familyAllMaxed": "Всe исчерпано — сброс через",
  "card.rowMaxedResetsIn": "{label} исчерпан — сброс через",
  "card.rowMaxedPending": "{label} исчерпан — ожидание следующего сброса",
  "card.familyAllMaxedPending": "Все аккаунты исчерпаны — ожидание следующего сброса",
  "card.foldedResetsIn": "Сброс через",
  "card.familyReady": "Квота доступна",
  "card.refresh": "Обновить этого провайдера сейчас",
  ...
  "spend.quotaBarTip": "Использовано {n}%",
  "spend.others": "Другие",
  ...
  "overview.sectionAvailable": "Доступны",
  "overview.expiring": "Ближайший сброс",
  "overview.expiringEmpty": "Нет известных сбросов",
  "overview.pendingReset": "Лимит — ждём сброса",
  "overview.noReset": "Нет времени сброса",
  "overview.sectionUnavailable": "Недоступны",
  "customize.groupLabel": "Группа карточек",
  "customize.groupNone": "Без группы",
  "customize.groupNew": "Новая группа",
  "customize.groupNewPrompt": "Название новой группы",
  "customize.groupRename": "Переименовать",
  "customize.groupRenameTip": "Переименовать группу",
  "customize.groupRenamePrompt": "Новое название группы",
  "customize.groupDelete": "Удалить",
  "customize.groupDeleteTip": "Удалить группу (карточки станут без группы)",
  "customize.groupDeleteConfirm": "Удалить группу «{name}»? Её карточки станут без группы.",
  "customize.groupHelp": "Карточки одной группы образуют раздел на главной; обзор можно фильтровать по группе.",
  "overview.refresh": "Обновить всё",
  "overview.groupHint": "ПКМ — группа",
  "overview.badge": "{avail}/{total} доступно",
  "overview.availShort": "доступно",
  "overview.maxedBadge": "{n} исчерпано",
  "overview.maxedShort": "исчерпано",
  "overview.peakBadge": "{n} в часах пик (стандартный тариф — вне пик дешевле)",
  "overview.peakShort": "пик",
  "overview.sectionPeak": "Часы пик",
  "overview.allAvailable": "Все доступны",
  "overview.win5h": "квота 5ч",
  "overview.winDay": "дневная квота",
  "overview.winWeek": "недельная квота",
  "overview.winMonth": "месячная квота",
  "overview.winGeneric": "квота",
  "overview.noData": "Нет данных об использовании",
  "overview.maxedTip": "Квота исчерпана (100%)",
  "overview.resetsIn": "сброс через {time}",
  "overview.jumpTip": "Перейти к {name}",
  ...
  "customize.connLabel": "Подключение:",
  "customize.onaAccountsHint": "Сайты — это аккаунты: добавьте сайт в списке выше (адрес и токен личного кабинета), и карточка появится на главной.",
  "customize.connOk": "OK — последний запрос успешен",
  "customize.connError": "Ошибка — {err}",
  "customize.connNoCred": "Нет учётных данных",
  "customize.connUnknown": "ещё не запрашивалось",
  ...
  "customize.credKimiEnv": "Kimi Coding API-ключ из переменной окружения",
  ...
  "customize.chipKimiEnvKey": "Kimi Coding API-ключ из переменной окружения",
  "customize.chipLocal": "Локальный вход: {x}",
  "customize.chipNone": "Не настроено",
  "customize.chipOAuth": "OAuth: {x}",
  "customize.chipKimiOAuth": "OAuth-учётные данные: {x}",
  ...
  "customize.acctNoteLabel": "Метка",
  "customize.acctLabelPh": "Метка",
  "customize.acctLabelRequired": "Введите метку перед проверкой",
  "customize.acctAdd": "Добавить аккаунт",
  "customize.acctClose": "Свернуть",
  "customize.acctSaveBtn": "Сохранить",
  ...
  "customize.acctDefaultFailed": "Не удалось закрепить аккаунт: {err}",
  "customize.acctRenamed": "Метка обновлена",
  "customize.acctRenameFailed": "Не удалось переименовать аккаунт: {err}",
  "customize.agCapture": "Захватить текущий аккаунт",
  "customize.agCaptureConfirm": "Сохранить Google-логин, активный в Antigravity IDE, в отслеживаемый слот? Токены хранятся локально и обновляются независимо.",
  "customize.agCaptured": "Аккаунт Antigravity захвачен и отслеживается параллельно",
  "customize.agCaptureFailed": "Не удалось захватить: {err}",
  "customize.cursorAddTitle": "Добавить аккаунт Cursor",
  "customize.cursorTabOAuth": "Вход через OAuth",
  "customize.cursorTabToken": "Токен",
  "customize.cursorTabJson": "Импорт JSON",
  "customize.cursorOAuthHelp": "Вход через сайт Cursor в браузере (PKCE). Квота аккаунта отслеживается независимо.",
  "customize.cursorOAuthStart": "Войти через браузер",
  "customize.cursorOAuthStarting": "Открываю браузер…",
  "customize.cursorOAuthWaiting": "Ожидание входа в браузере…",
  "customize.cursorOAuthDone": "Выполнен вход: {email}",
  "customize.cursorTokenLabel": "Access token",
  "customize.cursorRefreshLabel": "Refresh token (необязательно)",
  "customize.cursorTokenImport": "Импортировать токен",
  "customize.cursorTokenConfirm": "Импортировать токен в отслеживаемый аккаунт Cursor? Он хранится только на этом ПК и опрашивается независимо.",
  "customize.cursorJsonHelp": "Вставьте JSON в формате cockpit: объект, массив или {\"accounts\":[…]}. Поля принимают camelCase и snake_case.",
  "customize.cursorJsonImport": "Импортировать JSON",
  "customize.cursorImportDone": "Аккаунт импортирован",
  "customize.cursorImportCount": "Импортировано аккаунтов: {n}",
  "customize.getApiKey": "Получить API-ключ",
  "customize.formKeyHelp": "Хранится только на этом ПК и не загружается; пустое значение при сохранении удаляет ключ.",
  "customize.relayBaseUrlHelp": "Базовый URL эндпоинта квоты релея; сохраняется вместе с ключом.",
  ...
  "customize.cred.copilot": "Вход GitHub Copilot (OAuth Pane, gh CLI или приложение Copilot)",
  ...
  "customize.cred.linkso": "Сам ничего не читает — вставьте base URL и ключ панели релея",
