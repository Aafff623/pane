...
const en: Dict = {
  ...
  "customize.relayBaseUrlHelp": "Base URL of the OpenAI-compatible billing endpoint; saved together with the key.",
...
const zh: Dict = {
  ...
  "customize.relayBaseUrlHelp": "OpenAI 兼容计费接口的基地址，保存时与密钥一起存储。",
...
const ru: Dict = {
  ...
  "customize.relayBaseUrlHelp": "Базовый URL OpenAI-совместимого биллинг-эндпоинта; сохраняется вместе с ключом.",
